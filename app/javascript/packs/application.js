...
const quiz = [
  {
    ...
    question: '始業前の構内巡回時気を付けるべき点はどれ？',
    answers: [ '巡回終了報告時間前に巡回を終わらせる', 'ゴミが落ちてないかを特に注視して見回る', 'お客様が待っていたらきちんと挨拶する'],
    correct: '巡回終了報告時間前に巡回を終わらせる'
  }, {
    question: '一人勤務駅で車椅子ご案内のお客様がいらっしゃる際に窓口にもお客様が来た、正しい対応はどれ？',
    answers: [ '車椅子のお客様を優先する', '窓口のお客様を優先する', '後から来たお客様に待ってもらい先に来たお客様を優先する'],
    correct: '後から来たお客様に待ってもらい先に来たお客様を優先する'
  }, {
    question: '一人勤務駅で券売機で詰まりが発生した、中を見てみたがすぐに対応できそうにない。正しい対応はどれ？',
    answers: [ 'お客様を待たせて取り出せるまで頑張る', '諦めてお客様に謝罪する', '直ぐに対応できない事をまず謝罪をし、連絡先を聞き対応後にご連絡をする'],
    correct: '直ぐに対応できない事をまず謝罪をし、連絡先を聞き対応後にご連絡をする'
  }, {
    question: '改札で両替をしたいと申告があった、正しい対応はどれ？',
    answers: [ '申告通り両替を行う', '個人的な両替は規則で禁じられているので丁重にお断りする', '理由によっては出来るので理由を聞き是非を判断する'],
    correct: '個人的な両替は規則で禁じられているので丁重にお断りする'
  }
];
//長コードを短単語に定義
const $window = window;
